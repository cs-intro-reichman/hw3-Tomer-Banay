public class TestAnagram {
    ...
    public static int testRandomAnagram() {
        ...
        String randomized = Anagram1.randomAnagram(original);
        boolean test1 = Anagram1.isAnagram(original, randomized);
        ...
        String first = Anagram1.randomAnagram("testing");
        for (int i = 0; i < 10; i++) {
            String next = Anagram1.randomAnagram("testing");
